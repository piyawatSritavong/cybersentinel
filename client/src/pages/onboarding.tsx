        ...
        {step === 1 && (
          <Card data-testid="card-step-welcome">
            <CardContent className="p-6 text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Let's get your AI-native autonomous SOC configured in just a few
                steps. You can always change these settings later.
              </p>
              <div className="grid grid-cols-3 gap-3 pt-2">
                {[
                  ...
                  <div
                    key={item.label}
                    className="p-3 rounded-md bg-muted/50 text-center"
                  >
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    Get your free API key from groq.com to enable AI-powered
                    analysis.
                  </p>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Select what you'd like to enable (configure later in
                    Settings)
                  </p>
                </div>
              </div>
                ...
                {[
                  {
                    key: "splunk",
                    label: "Splunk SIEM",
                    desc: "Log ingestion and correlation",
                  },
                  {
                    key: "jira",
                    label: "Jira Ticketing",
                    desc: "Automated ticket creation",
                  },
                  {
                    key: "virustotal",
                    label: "VirusTotal",
                    desc: "Threat intelligence lookups",
                  },
                  {
                    key: "telegram",
                    label: "Telegram Gateway",
                    desc: "Alert notifications via Telegram",
                  },
                  {
                    key: "discord",
                    label: "Discord Gateway",
                    desc: "Alert notifications via Discord",
                  },
                  {
                    key: "slack",
                    label: "Slack Gateway",
                    desc: "Alert notifications via Slack",
                  },
                ].map((item) => (
                  <div
                    key={item.key}
        ...
        {step === 4 && (
          <Card data-testid="card-step-complete">
            <CardContent className="p-6 text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                CyberSentinel is ready to protect your infrastructure. You can
                configure additional integrations anytime from the Settings
                page.
              </p>
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="p-3 rounded-md bg-muted/50">
                  ...
                  <p className="text-sm font-medium mt-0.5">
                    {groqKey ? "Groq (configured)" : "Not set"}
                  </p>
                </div>
                <div className="p-3 rounded-md bg-muted/50">
                  <p className="text-xs text-muted-foreground">Integrations</p>
                  <p className="text-sm font-medium mt-0.5">
                    {Object.values(selectedIntegrations).filter(Boolean).length}{" "}
                    selected
                  </p>
                </div>
              </div>
